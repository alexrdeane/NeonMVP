...
public class Axis
{
    ...
    public const string HORIZONTAL_AXIS_2 = "Horizonta2";
    public const string VERTICAL_AXIS = "Vertical";
    public const string VERTICAL_AXIS_2 = "Vertical2";
}
...
public class Tags
{
    ...
    public const string LEFT_ARM_TAG_2 = "LeftArm2";
    public const string LEFT_LEG_TAG_2 = "LeftLe2";

    public const string MAIN_CAMERA_TAG = "MainCamera";
    public const string HEALTH_UI = "HealthUI";
    public const string HEALTH_UI_2 = "HealthUI2";
}
